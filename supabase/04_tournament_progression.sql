...
-- Run after 03_group_assignment_admin.sql.
...
begin
  insert into public.tournament_stage_config (
    tournament,stage,stage_type,stage_order,stage_start,stage_end,is_grouped,group_count,group_codes,
    teams_per_group,scheduled_matches_per_group,points_reset,advancement_rules,champion_rush_enabled
  ) values (
    p_tournament,'Group Stage','group_stage',1,date '2026-07-15',date '2026-07-16',true,2,array['A','B'],12,12,true,
    ...
    is_grouped=excluded.is_grouped,group_count=excluded.group_count,group_codes=excluded.group_codes,teams_per_group=excluded.teams_per_group,
